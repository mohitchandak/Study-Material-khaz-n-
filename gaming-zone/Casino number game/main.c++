...
int main(){
    ...
    std::cout << "==============================\n\n";
    std::cout << "WELCOME TO VIRTUAL Game TABLE" << std::endl;
    std::cout << "=================================" << std::endl;
    std::cout << "Player chooses between two sides either 'banker' or 'player'. After drawing two cards the one who has the nearest number to 9 wins." << std::endl;
